...
export default function COGEngine() {
  ...
  if (loading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', flexDirection: 'column', gap: '1rem' }}>
      ...
      <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem' }}>Initializing Cognitive Governance Engine...</p>
    </div>
  );
  ...
  return (
    <div style={{ padding: '2rem 1rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <motion.div {...fadeIn} style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 800, margin: '0 0 0.5rem', letterSpacing: '-0.03em' }}>Cognitive Governance Engine</h1>
