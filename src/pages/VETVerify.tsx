  ...
  return (
    <div style={{ padding: '2rem 1rem', maxWidth: '900px', margin: '0 auto' }}>
      ...
      <motion.div {...fadeIn} style={{ textAlign: 'center', marginBottom: '3rem' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 800, margin: '0 0 0.5rem', letterSpacing: '-0.03em' }}>FLA Verification Ledger</h1>
        <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem', maxWidth: '500px', margin: '0 auto', lineHeight: 1.6 }}>
          Public verification portal for FLA Private Ledger certificates. Enter a certificate ID or VIN to verify provenance and integrity.
        </p>
      ...
      {result && (
        <motion.div {...fadeIn}>
          ...
          <div style={{ ...panel, borderColor: 'rgba(16,185,129,0.3)', background: 'linear-gradient(180deg, rgba(16,185,129,0.06) 0%, transparent 100%)', textAlign: 'center', marginBottom: '1.5rem' }}>
            ...
            <p style={{ color: 'var(--text-dim)', fontSize: '0.8rem', margin: 0 }}>This certificate is cryptographically sealed and untampered on the FLA Private Ledger.</p>
        ...
        <motion.div {...fadeIn} style={{ marginTop: '2rem' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
            {[
              ...
              { icon: <Fingerprint size={20} />, title: 'Zero Data Exposure', desc: 'FLA-VL proves provenance without revealing internal operational data. The hash proves integrity — the source stores content.' },
            ].map((item, i) => (
