...
const APK_URL = 'https://lumescan.tech/releases/LumeScan_v1.0.0.apk';
...
export default function DownloadPage() {
  ...
  useEffect(() => {
    if (canvasRef.current) {
      // @ts-ignore
      QRCodeLib.toCanvas(canvasRef.current, 'https://fla.tlid.io/download', {
        width: 200,
        margin: 2,
        color: {
          dark: '#06b6d4',
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1rem', flexWrap: 'wrap' }}>
              ...
              <h2 style={{ fontSize: '1.4rem', margin: 0 }}>FLA Operating System</h2>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', lineHeight: 1.6, marginBottom: '1rem' }}>
              The enterprise desktop client for Fractal Ledger Architecture. Provides native access to FLA-OS Dashboard, FLA-PL Ledger Explorer, FLA-VL Verification Portal, CORE Root Fabric, and FLA-LGS Engine — plus Lot Ops Pro as a built-in native app. Full keyboard shortcuts for every section.
            </p>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  <div style={{ display: 'inline-block', padding: '6px 12px', background: 'rgba(56,189,248,0.1)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: '6px', color: '#38bdf8', fontSize: '0.7rem', fontWeight: 600, letterSpacing: '0.05em' }}>
                    FLA-OS v1.0.0 · Electron Runtime
                  </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', minWidth: '200px' }}>
                  ...
                  >
                    <Download size={18} /> DOWNLOAD FLA-OS .EXE
                  </a>
