        ...
        <div className="container" style={{ maxWidth: '1100px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1rem' }}>
            {[
              ...
              { title: 'TLL — Trust Layer Ledger', desc: 'Fractal ledger topology visualization. Shows how FLA tenant divisions (e.g., NetworkNode, TradeVault, PriceAxis, DealerGrid, LedgerCapital) each operate their own sovereign private ledger (powered by the CORE engine) while anchoring to the public TLL via hash anchoring.', color: '#8b5cf6', link: '/core' },
