...
const POSTS = [
  ...
  },
  {
    ...
    excerpt: 'The average check engine light costs $150 just to diagnose at a mechanic shop. With a $15 Bluetooth OBD-II scanner and LumeScan, that same information is delivered to your phone instantly — in plain English.',
    tag: 'Product',
  },
  {
    ...
    excerpt: 'Attention spans are short. LumeScan\'s Passive Audio Coach uses simple audio tones to subconsciously train drivers toward optimal throttle behavior — no screen required.',
    tag: 'Research',
  },
  {
    ...
    <div className="container" style={{ paddingBottom: '6rem' }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-6" style={{ maxWidth: '900px', margin: '0 auto', paddingTop: '4rem' }}>
        ...
        <p className="text-muted" style={{ fontSize: '1.2rem' }}>
          Technical dispatches from the LumeScan organism. Engineering insights, product strategy, and the science of deterministic vehicle governance.
        </p>
