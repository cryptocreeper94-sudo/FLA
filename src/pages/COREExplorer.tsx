...
const DIVISIONS = [
  { id: 'manheim', name: 'Manheim', desc: 'Wholesale Auction & Remarketing', color: '#38bdf8', ledger: 'CAL', certs: ['CUSTODY_TRANSFER', 'CONDITION_REPORT', 'DRIVER_PERFORMANCE', 'ARBITRATION_PROOF'] },
      ...
      <motion.div {...fadeIn} style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
          {[
            ...
            { icon: <Shield size={22} />, title: 'Cross-Division Verification', desc: 'When Manheim sells a vehicle financed by NextGear, VET issues a cross-division certificate. Both divisions can verify the transaction without accessing each other\'s internal records.', color: '#10b981' },
