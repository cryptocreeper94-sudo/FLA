...
const DIVISIONS = [
  { id: 'manheim', name: 'Manheim', desc: 'Wholesale Auction & Remarketing', color: '#38bdf8', ledger: 'COX-PL', certs: ['CUSTODY_TRANSFER', 'CONDITION_REPORT', 'DRIVER_PERFORMANCE', 'ARBITRATION_PROOF'] },
  { id: 'autotrader', name: 'Autotrader', desc: 'Consumer Vehicle Marketplace', color: '#10b981', ledger: 'ATL', certs: ['LISTING_VERIFICATION', 'PRICE_ANCHOR'] },
  { id: 'kbb', name: 'Kelley Blue Book', desc: 'Vehicle Valuation & Data', color: '#f59e0b', ledger: 'KBL', certs: ['VALUATION_ANCHOR', 'MARKET_DATA'] },
  { id: 'dealercom', name: 'Dealer.com', desc: 'Dealership Digital Solutions', color: '#8b5cf6', ledger: 'DCL', certs: ['DEALER_TRANSACTION', 'INVENTORY_SYNC'] },
  { id: 'nextgear', name: 'NextGear Capital', desc: 'Floor Plan Financing', color: '#ec4899', ledger: 'NGL', certs: ['LIEN_ORIGINATION', 'PAYOFF_RECORD', 'AUDIT_EVENT'] },
];
    ...
    <div style={{ padding: '2rem 1rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <motion.div {...fadeIn} style={{ textAlign: 'center', marginBottom: '3rem' }}>
        ...
        <p style={{ color: 'var(--text-dim)', fontSize: '0.9rem', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6 }}>
          The universal trust anchor for the entire Cox Enterprises ecosystem. Every division operates its own private ledger — all anchor to CORE.
        </p>
      </motion.div>
      ...
      <motion.div {...fadeIn} style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
          {[
            { icon: <Database size={22} />, title: 'Division Autonomy', desc: 'Each Cox division operates its own private Proof-of-Authority ledger. Manheim\'s COX-PL records auction events. NextGear\'s NGL records financing events. Data never crosses division boundaries.', color: '#38bdf8' },
            ...
            { icon: <Shield size={22} />, title: 'Cross-Division Verification', desc: 'When Manheim sells a vehicle financed by NextGear, COX-VL issues a cross-division certificate. Both divisions can verify the transaction without accessing each other\'s internal records.', color: '#10b981' },
