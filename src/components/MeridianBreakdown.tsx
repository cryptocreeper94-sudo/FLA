...
const components = [
  {
    img: '/assets/images/meridian/breakdown/anchor-node.png',
  ...
  {
    img: '/assets/images/meridian/breakdown/energy-router.png',
    ...
    detail: 'The router governs the radiative microwave power transmission (MPT). Energy is routed through directed beamforming, governed by the deterministic engine. Each packet of energy is metered, timestamped, and sealed before delivery. The router handles multi-vehicle simultaneous charging via spatial multiplexing — each vehicle receiver operates on an isolated targeting vector assigned by the deterministic engine.',
    color: '#dc2626',
  },
  {
    img: '/assets/images/meridian/breakdown/receiver-plate.png',
...
export default function MeridianBreakdown() {
  ...
  const renderCard = (comp: typeof components[0], idx: number, isCenter: boolean) => {
    ...
    return (
      ...
      >
        <div style={{ width: '100%', height: '160px', borderRadius: '14px', overflow: 'hidden', marginBottom: '1rem' }}>
          <img src={comp.img} alt={comp.title} style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" />
        </div>
      ...
      <div className="container" style={{ maxWidth: '1100px', position: 'relative', zIndex: 2 }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p className="text-muted" style={{ maxWidth: '620px', margin: '0 auto', fontSize: '0.95rem', lineHeight: 1.7 }}>
            Six subsystems under unified deterministic governance. Tap any component to see the full technical specification.
          </p>
        </div>
