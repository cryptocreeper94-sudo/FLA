          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '0.88rem', lineHeight: 1.75, color: 'var(--text-muted)', margin: 0 }}>
                ...
                I built the <strong>Fractal Ledger Architecture (FLA)</strong> anchored to a universal <strong>CORE</strong> root fabric. Each division operates its own isolated dual-ledger: the <strong>FLA Private Ledger (FLA-PL)</strong> is strictly internal — a notarized logbook on your own servers tracking every lane move and scan. The <strong>FLA Verification Ledger (FLA-VL)</strong> ledger is external — a secure way to cryptographically prove vehicle condition to buyers and financing partners without ever exposing your internal operations. Both anchor to CORE, but CORE never sees your data — only cryptographic proof that the data is intact. No one can alter the records after the fact. It's simply a better way to keep data that can't be disputed.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '0.88rem', lineHeight: 1.75, color: 'var(--text-muted)', margin: 0 }}>
                It's an infrastructure layer that sits on top of what NetworkNode already runs. It doesn't replace your systems — including your existing FLA2M telematics dongles, which stay exactly where they are. 
