      ...
      <div className="container" style={{ position: 'relative', zIndex: 2, maxWidth: '1100px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem', marginBottom: '3rem' }}>
          {[
            ...
            { icon: <ShieldCheck size={22} />, title: 'Packetized Ledger Metering', desc: 'Energy is routed in discrete, timestamped packets. Every watt delivered is metered and securely signed to the FLA-PL ledger, creating a tamper-proof, auditable history of consumption.' },
          ].map((item, i) => (
        ...
        <motion.div {...fadeIn} transition={{ delay: 0.3 }} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
          ...
          <div className="panel" style={{ padding: '2.25rem', borderColor: accentBorder, background: `linear-gradient(180deg, ${accentDim} 0%, transparent 100%)` }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', fontFamily: 'var(--font-mono)', fontSize: '0.85rem' }}>
              ...
              <div style={{ padding: '1rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <div style={{ color: 'var(--text-muted)' }}>Energy is delivered in cryptographically signed micro-bursts. The RX node acknowledges receipt, and the TX node anchors the micro-transaction to the private FLA-PL ledger for deterministic billing.</div>
              </div>
            </div>
          </div>
          ...
          <div className="panel" style={{ padding: '2.25rem', borderColor: 'rgba(16,185,129,0.15)', background: 'linear-gradient(180deg, rgba(16,185,129,0.03) 0%, transparent 100%)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <p className="text-muted" style={{ lineHeight: 1.6, marginBottom: '1.25rem', fontSize: '0.9rem' }}>
              NetworkNode lots are transitioning to handle increasing EV volume. Traditional charging creates ground-level obstacles, adapter bottlenecks, and untrackable energy sinkholes. Meridian solves this architecturally:
            </p>
