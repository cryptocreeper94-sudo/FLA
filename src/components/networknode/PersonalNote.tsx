      ...
      <div className="container" style={{ maxWidth: '780px' }}>
        ...
        >
          ...
          <div style={{ fontSize: '0.95rem', lineHeight: 1.8, color: 'var(--text-muted)' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>
              I know this is a lot. There are more than a dozen sections below covering everything from the governance substrate to the Fractal Ledger Architecture (FLA) 
            ...
            <p style={{ marginBottom: '1rem' }}>
              The short version: this is an infrastructure modernization platform built specifically for the massive scale and complexity of the entire FLA Enterprise ecosystem. 
              While it drops seamlessly into NetworkNode's current workflows today, the fractal architecture is designed to scale horizontally across every division of FLA Enterprise without replacing what you already have.
            </p>
