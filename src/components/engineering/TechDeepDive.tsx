...
const SUBSYSTEMS = [
  ...
  { icon: <Lock size={18}/>, title: 'Fractal Trust Chain (COX-PL)', items: ['Proof-of-Authority cryptographic ledger', 'Deterministic consensus — no mining, no gas fees', 'Each facility operates as a validator node', 'Condition certificates anchored immutably on-ledger', 'Cryptographic replay verification for arbitration', 'Purpose-built for closed-loop enterprise networks'], color: '#38bdf8' },
  ...
  { icon: <Radio size={18}/>, title: 'Voice Intelligence (Optional)', items: ['LLM-agnostic bidirectional voice engine', '15+ hands-free commands', 'All output governed by LUME-V substrate', 'Speech pattern learning per driver', 'Noise cancellation for lot environments', 'Can be disabled per-facility'], color: '#38bdf8' },
  ...
  { icon: <Wrench size={18}/>, title: 'Lume-V Verification Substrate', items: ['Production-ready verification layer', 'Operates as a substrate beneath any existing system or API', 'No source code modification required', 'Injects deterministic audit trail', 'Incremental adoption — system by system', 'Published: DOI 10.5281/zenodo.19645097'], color: '#fb923c' },
  ...
  { icon: <ShieldCheck size={18}/>, title: 'COX Verification Ledger (COX-VL)', items: ['Public commercial verification ledger', 'Dual-ledger per division (COX-PL + COX-VL)', 'Ed25519 cryptographic signatures', 'Isolates DarkWave core IP', 'Proves provenance to buyers/dealers', 'Mathematically verifiable audit trail'], color: 'var(--accent-cyan)' },
  { icon: <Hexagon size={18}/>, title: 'Meridian Energy Protocol', items: ['Radiative microwave power transmission (MPT)', '5.8GHz solid-state phased-array nodes', 'Zero OEM integration required', 'Universal rectenna retrofit bolt-on', 'Packetized energy routing via tokenization', 'Patent Pending: U.S. Prov 64/084,465'], color: '#fb923c' },
];
