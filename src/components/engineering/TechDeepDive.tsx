...
const SUBSYSTEMS = [
  ...
  { icon: <Lock size={18}/>, title: 'Fractal Trust Chain (FLA-PL)', items: ['Proof-of-Authority cryptographic ledger', 'Deterministic consensus — no mining, no gas fees', 'Each facility operates as a validator node', 'Condition certificates anchored immutably on-ledger', 'Cryptographic replay verification for arbitration', 'Purpose-built for closed-loop enterprise networks'], color: '#38bdf8' },
  ...
  { icon: <ShieldCheck size={18}/>, title: 'FLA Verification Ledger (FLA-VL)', items: ['Public commercial verification ledger', 'Dual-ledger per division (FLA-PL + FLA-VL)', 'Ed25519 cryptographic signatures', 'Isolates DarkWave core IP', 'Proves provenance to buyers/dealers', 'Mathematically verifiable audit trail'], color: 'var(--accent-cyan)' },
