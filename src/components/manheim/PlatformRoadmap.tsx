...
const PHASES = [
  ...
  },
  {
    ...
    apps: [
      ...
      { icon: <ShieldCheck size={20} />, name: 'Safety OS', desc: 'Enterprise-wide safety compliance for every Cox subsidiary — not just the lot. Lot Ops Pro\'s built-in safety module covers auction facility operations; Safety OS extends that to Autotrader, Kelley Blue Book, Dealertrack, vAuto, Xtime, and corporate offices. Incident reporting, near-miss logging, training certification tracking, OSHA-aligned workflows, and cross-division compliance dashboards — all sealed on the COX-PL.' },
    ],
  },
  {
    phase: 'Planned',
