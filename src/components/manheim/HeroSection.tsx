      ...
      <div className="container" style={{ maxWidth: '1100px', position: 'relative', zIndex: 2 }}>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted" style={{ fontSize: '1.1rem', lineHeight: 1.7, maxWidth: '800px', marginBottom: '2rem' }}>
            A deterministic operations platform that delivers verifiable, tamper-proof records of every physical event. Designed as a universal architecture for global operators, this deployment features a fractal dual-ledger network that structurally isolates data across every division of the Cox ecosystem. Powered by the universal CORE root and Lume-V governance substrate, the system brings cryptographic condition reports, deterministic lot workflows, and mathematical proof to Manheim and the Cox Enterprise family as a whole.
          </p>
