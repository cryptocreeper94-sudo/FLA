  ...
  return (
    <section style={{ padding: '6rem 0', position: 'relative', overflow: 'hidden', background: 'var(--bg-dark)', borderBottom: '1px solid var(--border-light)' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2, maxWidth: '1100px' }}>
        <img src="/assets/images/photos/vet-infrastructure.png" alt="VET — Verified Enterprise Trust infrastructure" style={{ width: '100%', maxWidth: '800px', margin: '0 auto 2.5rem auto', display: 'block', height: 'auto', borderRadius: '20px', border: `1px solid ${accentDim}`, opacity: 0.8 }} />
