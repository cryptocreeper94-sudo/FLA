        ...
        <div className="panel" style={{ padding: '2rem', background: 'rgba(255,255,255,0.02)' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
            ...
            <p style={{ fontSize: '0.75rem', color: 'var(--text-dim)', lineHeight: 1.5, margin: 0 }}>
              {mode === 'register'
                ? 'Use your @coxautoinc.com email to create a new account.'
          ...
          <p style={{ fontSize: '0.65rem', color: 'var(--text-dim)', textAlign: 'center', margin: '0.5rem 0 0', lineHeight: 1.4 }}>
            Use your <strong style={{ color: b.accent }}>@coxautoinc.com</strong> Google account
          </p>

          {/* Divider */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '1.25rem 0' }}>
            <div style={{ flex: 1, height: 1, background: 'var(--border-light)' }} />
            <span style={{ fontSize: '0.7rem', color: 'var(--text-dim)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>or use email & password</span>
            <div style={{ flex: 1, height: 1, background: 'var(--border-light)' }} />
          </div>
